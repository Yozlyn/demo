<template>
  ...
  <el-table :data="state.tableData" style="width: 100%" border stripe>
    ...
    <el-table-column prop="logisticsId" label="物流ID" width="120" />
    <el-table-column prop="companyName" label="公司名称" width="150" />
    <el-table-column prop="trackingNumber" label="追踪号码" width="180" />
...
const rules = reactive({
  ...
  deliveryDate: [
    { required: true, message: '送达日期不能为空', trigger: 'blur' },
  ],
})
